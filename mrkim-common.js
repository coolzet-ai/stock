...
let BACKTEST_START_YEAR=2025; // 2024/2025/2026 중 선택 — 트레이드 탭의 연도 선택 버튼으로 변경됨
  ...
  if(curveEl){
    ...
    res.curve.forEach((p,i)=>{
      ...
      if(mk!==prevMk){
        ...
        gridLines+='<line x1="'+x+'" y1="'+padTop+'" x2="'+x+'" y2="'+(h-padBottom)+'" stroke="var(--line)" stroke-width="1" stroke-dasharray="3 3"/>';
